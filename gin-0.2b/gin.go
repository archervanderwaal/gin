...
// 获取一个特定的key对应的value, 如果key不存在, 返回一个error
...
// MustGet 获取一个指定的key对应的value, 如果key不存在, 则panic
...
// 根据Context的Request获取Content-Type来选择Binding
